...
--
ALTER TABLE `attendanceslot`
  MODIFY `slotID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `attendancelist`
  ADD CONSTRAINT `attendancelist_ibfk_1` FOREIGN KEY (`studentID`) REFERENCES `student` (`studentID`),
  ADD CONSTRAINT `attendancelist_ibfk_2` FOREIGN KEY (`slotID`) REFERENCES `attendanceslot` (`slotID`);
