...
<body>
    <!-- Original Sidebar -->
    <div class="sidebar">
        <a href="student.php"><img src="images/petakom.png" alt="PETAKOM Logo" class="logo"></a>
        <hr>
        <a href="studProfile.php" class="nav-item">Profile</a>
        <hr>
        <a href="student.php" class="nav-item">Dashboard</a>
        <hr>
        <a href="studMembership.php" class="nav-item">Apply<br>Membership</a>
        <hr>
